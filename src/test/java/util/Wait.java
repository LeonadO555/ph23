...
public class Wait {
    ...
    public void forVisibility(WebElement element){
        try{
            ...
            throw new TimeoutException("Waiting for visibility: "+ element + "more then"+ TIMEOUT + "seconds");
        }
    }
    ...
    public void forVisibilityAll(List<WebElement> elements){
        try{
            ...
            throw new TimeoutException("Waiting for visibility: "+ elements + "more then"+ TIMEOUT + "seconds");
        }
    }
